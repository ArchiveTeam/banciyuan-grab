...
project = Project(
    ...
    project_html='''
        ...
        <h2>半次元 <span class="links"><a href="https://bcy.net/">Website</a> &middot; <a href="http://tracker.archiveteam.org/banciyuan/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Banciyuan">Wiki</a></span></h2>
        <p>Archiving 半次元 (Banciyuan).</p>
    '''
)
