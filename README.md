...
More information about the archiving project can be found on the ArchiveTeam wiki: [半次元](https://wiki.archiveteam.org/index.php?title=半次元)
...
after which the project container can be run:
    ...
    docker run -d --name archiveteam --label=com.centurylinklabs.watchtower.enable=true --restart=unless-stopped atdr.meo.ws/archiveteam/banciyuan-grab --concurrent 1 YOURNICKHERE
